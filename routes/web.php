...
Route::post('PostVideos', 'AdminController@postVideos');
Route::get('SearchVideos', 'AdminController@searchVideos');
Route::get('AddMoreVideos', 'AdminController@addVideos');
Route::get('RemoveVideos', 'AdminController@removeVideos');
Route::post('post_new_video}', 'AdminController@post_new_video')->name('post_new_video');
...
Route::post('PostImages', 'AdminController@postImages');
Route::get('SearchImages', 'AdminController@searchImages');
Route::get('AddMoreImages', 'AdminController@addImages');
Route::get('RemoveImages', 'AdminController@removeImages');
Route::post('post_new_image}', 'AdminController@post_new_image')->name('post_new_image');

Route::any('delete_image/{id}','AdminController@delete_image')->name("delete_image");

//Admin can add audios
Route::any('/AddAudios', 'AdminController@getAudios')->name("AddAudio");
//Route::get('/AddAudios', 'AdminController@getAudios')->name("AddNewAudio");
Route::post('PostAudios', 'AdminController@postAudios');
Route::get('SearchAudios', 'AdminController@searchAudios');
Route::get('AddMoreAudios', 'AdminController@addAudios');
Route::get('RemoveAudios', 'AdminController@removeAudios');
Route::post('post_new_audio}', 'AdminController@post_new_audio')->name('post_new_audio');
