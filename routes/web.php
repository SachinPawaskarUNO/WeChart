...
Route::get('/editAudio/{id}','AdminController@edit_audio');
Route::get('add_new_audio','AdminController@add_new_audio')->name("add_new_audio");;
Route::post('post_new_audio_link}', 'AdminController@post_new_audio_link')->name('post_new_audio_link');
