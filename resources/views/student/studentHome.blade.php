                            ...
                            @foreach($saved_patients_modules as $module)
                                ...
                                <div class="panel panel-default" style="border-color: transparent" >
                                    <div class="panel-heading" style="padding: 0">
                                        <a href="#0" id="savedModuleName" style="margin-top: 0; text-align: left; padding-left: 25px;"><span id="<?php echo "plus".$modid; ?>" class="plus fa fa-plus"></span><span id="<?php echo "minus".$modid; ?>" class="minus fa fa-minus"></span> {{$module}}</a>
                                    </div>
                                    
                                    <div class="panel-body" id="modulepanel"> 
                                    <div id="module_wrap" style="display: none;"> 
                                        @if($saved_patients)
                    ...
                    <div class="panel-body" style="margin-bottom: 0;padding-bottom: 0">
                            @if(count($submitted_patients_modules)>0)
                                ...
                                @foreach($submitted_patients_modules as $module)
                                    ...
                                    <div class="panel panel-default" style="border-color: transparent">
                                        <div class="panel-heading" style="padding: 0;">
                                            <a href="#0" id="savedModuleName" style="margin-top: 0; text-align: left; padding-left: 25px;"><span id="<?php echo "pluss".$modid; ?>" class="plus fa fa-plus"></span><span id="<?php echo "minuss".$modid; ?>" class="minus fa fa-minus"></span> {{$module}}</a>
                                        </div>
