        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="row" style="padding-bottom: 20px;">
                ...
                <div class="col-md-10" style="text-align: right">
                    <a class="btn btn-primary" href={{url('/AddAudios')}}><span class="fa fa-volume-up"></span>
                        Audio</a>
                    <a class="btn btn-primary" href={{url('/AddVideos')}}><span class="fa fa-youtube-play"></span>
                        Video</a>
                    <a class="btn btn-primary" style="background-color: #1A3765" href={{url('/AddImages')}}><span class="fa fa-image"></span>
                        Image</a>
                </div>
            </div>
            <br>
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{url("PostImages")}}">
                        {{ csrf_field() }}
                        @for ($i = 0; $i < $counter ; $i++)
                        ...
                        <div style="padding-top: 10px; padding-right: 10px;">
                            <div class="col-md-2" style="float:right">
                                <a href="#" type="button" id="addimage" style="color: #3097D1;">
                        ...
                        <div class="form-group" style="padding-top: 20px;">
                            <div align="center">
                                <button type="submit" class="btn btn-primary" id="saveimage">
        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel-body">
                ...
                <div class="navbar-right">
                    <div class="row">
                        <div class="col-md-10"><input id="search_images" type="text" class="form-control" name="search" placeholder="Search Image..."></div>
                ...
                <div class="panel-body">
                    <table class="table table-striped table-bordered table-hover" id="image_table" >
                        ...
                        @foreach ($images as $image)
                            <?php $rownum=$rownum+1; ?>
                            <tr>
                                <td><?php echo($image->image_lookup_value_tag); ?> </td>
                                <td><?php echo($image->image_lookup_value_link); ?></td>
                                <td style="text-align: right">
                                    ...
                                    <button style="height:37px" class="saveButton btn btn-success" id="<?php echo $rownum ?>" value="{{$image->image_lookup_value_id}}"><i class="fa fa-save" aria-hidden="true"></i></button>
                                </td>
                                <td style="text-align: right">
                                    <a style="padding-top:10px; height:37px" href="{{ route('delete_image', ['id' => $image->image_lookup_value_id]) }}" class="btn btn-danger enable" id="delete" onclick="return Delete()">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#search_images').on('keyup',function(){
                ...
                $.ajax({
                    type : 'get',
                    url : '{{url("SearchImages")}}',
                    data:{'search':$value},
                    success:function(data){
                        $('#timagebody').html(data);
                        cssProp();
            ...
            function edit(id) {
                ...
                document.getElementById("image_table").rows[id].cells[0].contentEditable='true';
                document.getElementById("image_table").rows[id].cells[1].contentEditable='true';
            }
            ...
            function save(id,value) {
                ...
                document.getElementById("image_table").rows[id].cells[0].contentEditable='false';
                document.getElementById("image_table").rows[id].cells[1].contentEditable='false';
                arr.push(document.getElementById("image_table").rows[id].cells[0].innerHTML);
                arr.push(document.getElementById("image_table").rows[id].cells[1].innerHTML);
                arr.push(value);
                $.ajax({
                    headers: {
