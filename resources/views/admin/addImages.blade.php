...
@section('content')
                        ...
                        @foreach ($images as $image)
                            ...
                            <tr>
                                ...
                                <td style="text-align: right">
                                    ...
                                    <button class="saveButton btn btn-success" id="<?php echo $rownum ?>" value="{{$image->image_lookup_value_id}}"><i class="fa fa-save" aria-hidden="true"></i></button>
                                </td>
                                <td style="text-align: right">
                                    <a href="{{ route('delete_image', ['id' => $image->image_lookup_value_id]) }}" class="btn btn-danger enable" id="delete" onclick="return Delete()">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $(".editButton").click(function(){
                var id = $(this).attr('id');
               // $(this).closest("tr").css("background-color", "#C5D5E5");
                edit(id);
