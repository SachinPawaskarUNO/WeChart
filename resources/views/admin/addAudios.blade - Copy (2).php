...
@section('content')
            ...
            <div class="col-md-10 col-md-offset-1">
                <div class="panel-body">
                    <div class="navbar-form navbar-left">
                        <a id="audio-refresh" href="{{url('/AddAudios')}}" class="btn btn-success">
    ...
    <script>
        ...
        $("#audio-refresh").on("click",function(e){
            e.preventDefault();
            $("#audio_table").load("addAudios.blade.php #audio_table");
        });
