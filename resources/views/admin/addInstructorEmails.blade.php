        ...
        $(document).ready(function() {
            ...
            $(add_button).click(function(e){ //on add input button click
                ...
                if(x < max_fields){ //max input box allowed
                    ...
                    $(wrapper).append('<div class="row"><br><div class="col-md-11"><input class="test form-control" type="email" name="email[]" id="email[]" required></div><div class="col-md-1" ><a href="#" class="remove_field"><i class="fa fa-close" style="font-size:25px"></i></a></div></div>'); //add input box
                }
            });
