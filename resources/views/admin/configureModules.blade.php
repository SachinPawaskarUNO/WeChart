                ...
                <tr>
                    <td style="background-color:#5DADE2;">
                        <h5 style="width: 150px;margin-left: 1%;margin-right: 1%">
                            <h4 style="color: #000000">Module <i class="fa fa-arrows-v" aria-hidden="true"></i>/Navigations
                                <i class="fa fa-arrows-h" aria-hidden="true"></i></h4>
                        </h5>
                    </td>
                ...
                <tr>
                    ...
                    @foreach ($navs as $nav)
                        @if($nav->navigation_id == '2' || $nav->navigation_id == '9' || $nav->navigation_id == '20')
                            <td style="background-color:#5DADE2;" align="middle">
                                <h5 style="padding-left: 1%;padding-right: 1%;width: 100px">
                                    <b>{{ $nav->navigation_name }}- All</b></h5>
                            </td>
                        @else
                            @if($nav->parent_id != NULL)
                ...
                <tr>
                    ...
                    @foreach ($navs as $nav)
                        <td align="middle">
                            ...
                            @else
                                <input type="checkbox" id={{$nav->navigation_id}} name="navs[]"
