...
@section('content')
        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="row" style="padding-bottom: 20px;">
                ...
                <div class="col-md-10" style="text-align: right">
                    <a class="btn btn-primary" style="background-color: #1A3765" href={{url('/AddAudios')}}><span class="fa fa-volume-up"></span>
                        Audio</a>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{url("PostAudios")}}">
                        {{ csrf_field() }}
                        @for ($i = 0; $i < $counter ; $i++)
        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel-body">
                ...
                <div class="navbar-right">
                    <div class="row">
                        <div class="col-md-10"><input id="search_audios" type="text" class="form-control" name="search" placeholder="Search Audio..."></div>
            ...
            <div class="panel panel-default" style="margin-bottom: 0;padding-bottom: 0">
                <div class="panel-body">
                    <table class="table table-bordered table-stripped table-hover" id="audio_table">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#search_audios').on('keyup',function(){
                $value=$(this).val();
                $.ajax({
                    type : 'get',
                    url : '{{url("SearchAudios")}}',
                    data:{'search':$value},
                    success:function(data){
                        $('#taudiobody').html(data);
                        cssProp();
            ...
            function edit(id) {
                ...
                document.getElementById("audio_table").rows[id].cells[0].contentEditable='true';
                document.getElementById("audio_table").rows[id].cells[1].contentEditable='true';
            }
            ...
            function save(id,value) {
                ...
                document.getElementById("audio_table").rows[id].cells[0].contentEditable='false';
                document.getElementById("audio_table").rows[id].cells[1].contentEditable='false';
                arr.push(document.getElementById("audio_table").rows[id].cells[0].innerHTML);
                arr.push(document.getElementById("audio_table").rows[id].cells[1].innerHTML);
                arr.push(value);
