                            ...
                            <table class="table table-striped table-bordered table-hover">
                                ...
                                @foreach ($studentDetails as $studentDetail)
                                    <tr>
                                        ...
                                        <td><p>Student</p></td>
                                        <td>
                                            <p><?php echo(date('m-d-Y', strtotime($studentDetail[0]->created_at))); ?></p>
                                        </td>
                                        ...
                                        <td style="text-align: right">
                                            ...
                                            <button id="student_minus_delete"
                                                    data-id='<?php echo $studentDetail[0]->id;?>'
                            ...
                            <table class="table table-striped table-bordered table-hover">
                                ...
                                @foreach ($instructorDetails as $instructorDetail)
                                    <tr>
                                        ...
                                        <td>
                                            <p><?php echo(date('m-d-Y', strtotime($instructorDetail[0]->created_at))); ?></p>
                                        </td>
                                        <td style="text-align: right">
                                            ...
                                            <button id="student_minus_delete"
                                                    data-id='<?php echo $instructorDetail[0]->id;?>'
                                                    style="margin:auto;  text-align:center; display:block; width:100%;"
                                                    class="btn btn-danger btn-sm">
                                                Delete
                                            </button>
