...
<div class="loginBox">
    ...
    <img src="/logos/WeChart_Logo_JPEG_BLK.jpg" class="logo">
    ...
    <div class="form-group">
        ...
        <a href="#login-box" class="login-window">About WeChart</a><br>
            <div id="login-box" class="login-popup">
                ...
                WeChart was developed by the Department of Emergency Medicine at The University of Nebraska Medical Center (UNMC), in collaboration with The University of Nebraska Omaha (UNO). Our goal was to optimize the learning experience for health care students during their clinical internships.</h3>
