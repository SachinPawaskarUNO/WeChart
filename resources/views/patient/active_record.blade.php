            ...
            <div class="col-md-4 guidance" style="float: right;border: thin solid grey; height: auto; padding: 0; border-radius: 5px;" id="guidance_panel">
                ...
                <div class="container-fluid" id="tabdiv">
                    <ul class="nav nav-pills" id="myTab">
                        <li id="changetets"  class="active" style="background-color: #E0E0E0"><a data-toggle="pill" href="#main" class="text-danger">Main</a></li>
                        <li id="test"><a data-toggle="pill" href="#ddx" class="text-danger" style="background-color: #E0E0E0">DDx</a></li>
                        <li><a data-toggle="pill" href="#av" class="text-danger" style="background-color: #E0E0E0">A/V</a></li>
                    </ul>
