...
@section('documentation_panel')
                ...
                <!-- <div class="row" style="position: fixed; background: white; width: 0%;">
                            <button type="submit" id="btn_save_all" class="btn btn-primary" style="float: left">
    ...
    @endif
                        <div class="container-fluid;">
                        <div class="panel panel-default; background-color: transparent;">
                        <div class="panel-body">
                        <div class="button button-block" style="float: right">
                        <div class="col-md-6">
                            <button type="submit" id="btn_save_all" class="btn btn-primary">
