	...
	@if(Auth::user()->role =='Student')
        @if($notification->read_at == null)
            <a class="btn btn-default" style="background-color:#43ACAC;color:white" href="{{ route( 'student_notification_preview', ['notification_id' => $notification->id ] ) }}" id="previewsnot">
         @else
	...
	@else
                        @if($notification->read_at == null)
            <a class="btn btn-default" style="background-color:#43ACAC;color:white" href="{{ route( 'patient_notification_preview', ['notification_id' => $notification->id ] ) }}" id="previewnot">
                @else
