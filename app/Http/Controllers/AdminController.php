                ...
                foreach ($audios as $key => $audio) {
                    ...
                    $output.='<tr>'.
                        ...
                        '<td style="text-align: right">'.
                                ...
                                '</td>'.
                        '<td>'.'<a href="'.route('delete_audio',[ $audio->audio_lookup_value_id]).'" class="btn btn-danger enable" id="delete" onclick="return Delete()"> <i class="fa fa-trash-o" aria-hidden="true"></i>
                                        </a>'.'</td>'.
            ...
            if($videos)
            {
                foreach ($videos as $key => $video) {
                    ...
                    $output.='<tr>'.
                        ...
                        '</td>'.
                        '<td>'.'<a href="'.route('delete_video',[ $video->video_lookup_value_id]).'" class="btn btn-danger enable" id="delete" onclick="return Delete()"> <i class="fa fa-trash-o" aria-hidden="true"></i>
                                        </a>'.'</td>'.
            ...
            if($images)
            {
                foreach ($images as $key => $image) {
                    ...
                    $output.='<tr>'.
                        ...
                        '</td>'.
                        '<td>'.'<a href="'.route('delete_image',[ $image->image_lookup_value_id]).'" class="btn btn-danger enable" id="delete" onclick="return Delete()"> <i class="fa fa-trash-o" aria-hidden="true"></i>
                                        </a>'.'</td>'.
